...
//    }
    ...
    public static File createNioFile(java.io.File file, long projectId, String source, String sourceType) throws IOException {
    ...
    public static File createFromString(String content, String mimeType, String fileName, long projectId, String source, String sourceType) throws IOException {
        File f = new File();
        f.setName(fileName);
        f.setFileType(mimeType);
        f.setProjectId(projectId);
