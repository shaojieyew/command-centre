...
public class FileBackupSvc {
    ...
    public void backup(String name, String[] backupList) throws Exception {
        backup( name, Arrays.stream(backupList).collect(Collectors.toList()));
    }

    public void backup(String name, List<String> backupList) throws Exception {
...
//                }
    ...
    public boolean restoreBackup(String backupId) throws Exception {
        return restoreBackup( backupId, false);
    }

    public boolean restoreBackup(String backupId, boolean ignoreConflict) throws Exception {
