...
//    private final static String TYPE_CONFIG= "c";
//    public String[] args;
//
...
//                    switch (get_type()){
//                        case TYPE_APP:
//                            createSpec.startTask(this, getSpecFile().stream()
...
//                }else{
//                    if(getSpecFile().size()>0){
//                        List<Kind> k = getSpecFile().stream()
//                                .filter(s->(s instanceof NifiQueryKind || s instanceof AppDeploymentKind)).collect(Collectors.toList());
//                        createSpec.startTask(this, k);
//                        runNifi.startTask(this);
//                        runApp.startTask(this);
//                    }
//                }
...
//                            break;
//                        case TYPE_CONFIG:
//                            C2CliProperties prop = getC2CliProperties();
